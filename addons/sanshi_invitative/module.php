...
class sanshi_invitativeModule extends WeModule
{
    public $name = 'sanshi_invitativeModule';
    public $title = '邀请函';
    public $ability = '';
    public $tablename = 'sanshi_invitative_reply';
    public $action = 'detail'; //方法
    public $modulename = 'sanshi_invitative'; //模块标识
