...
define('RES', '../addons/sanshi_invitative/template/');
//define('LOCK', 'Li4vYWRkb25zL3dlaXNyY19kaXNoL3RlbXBsYXRlL2ltYWdlcy92ZXJzaW9uLmNzcw==');
include "../addons/sanshi_invitative/model.php";

class sanshi_invitativeModuleSite extends WeModuleSite
{
    public $cur_version = '20140917';
    //模块标识
    public $modulename = 'sanshi_invitative';
    ...
    public function doMobileGuestinfo()
    {
        ...
        pdo_insert('sanshi_invitative_user', $data);
    ...
    public function doWebActivity()
    {
        ...
        $tpl = dir(IA_ROOT . '/addons/sanshi_invitative/template/images/card_images/');
        $tpl->handle;
        $theme_array = array();
        ...
        if ($operation == 'post') {
            ...
            if (!empty($item)) {
                ...
                if ($item['cardtype'] == 1) {
                    ...
                    $page_cardbg = '../addons/sanshi_invitative/template/images/card_images/' . $cardbg_tmp;
                }
            } else {
