...
define('RES', '../addons/demo_choujiang/template/');
include "../addons/demo_choujiang/model.php";

class demo_choujiangModuleSite extends WeModuleSite
{
    public $cur_version = '20140917';
    public $modulename = 'demo_choujiang';

    public $_debug = '1'; //default:0
    public $_weixin = '1'; //default:1

    public $_appid = 'wx3db5943239313a96';
    public $_appsecret = '6def64de0b143c335d2871af34081011';
