...
defined('IN_IA') or exit('Access Denied');
	...
	if ($_GPC['id'] == 0) {
		...
		if ($is_save) {
			...
			$setting_data['is_comment']=$settings['mr_plg'];
...
<div id="style-guanzhu" class="tab-pane active">
	...
	<div id="guanzhu-list" class="ui-portlet clearfix ">
		...
		<ul id="loader" class="editor-template-list ui-portlet-list">
			...
			';
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=1 order by id desc");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
			$code = $myrow[3];
			echo "<li class='col-xs-12 brush' data-id='{$sid}'>";
			echo $code;
...
<div id="style-title" class="tab-pane">  
	...
	<div id="title-list" class="ui-portlet clearfix ">
		...
		<ul id="loader" class="editor-template-list ui-portlet-list">
					...
					';		
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=2 order by id desc limit 6");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
	...
	$res = mysql_query("select * from {$wxstyle} where type=2 order by id desc limit 6", $link);
	if ($myrow = mysql_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
...
<div id="body-list" class="ui-portlet clearfix ">
    ...
    <ul id="loader" class="editor-template-list ui-portlet-list">
        ...
        ';	
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=3 order by id desc limit 6");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
	...
	$res = mysql_query("select * from {$wxstyle} where type=3 order by id desc limit 6", $link);
	if ($myrow = mysql_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
    ...
    <div id="style-img" class="tab-pane">
        ...
        <div id="img-list" class="ui-portlet clearfix ">
            ...
            <ul id="loader" class="editor-template-list ui-portlet-list">
                ...
                ';
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=5 order by id desc limit 6");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
	...
	$res = mysql_query("select * from {$wxstyle} where type=5 order by id desc limit 6", $link);
	if ($myrow = mysql_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
...
<div id="hutui-list" class="ui-portlet clearfix ">
    <ul id="loader" class="editor-template-list ui-portlet-list">
        ...
        ';
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=4 order by id desc limit 6");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
	...
	$res = mysql_query("select * from {$wxstyle} where type=4 order by id desc limit 6", $link);
	if ($myrow = mysql_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
...
<div id="yuanwen-list" class="ui-portlet clearfix ">
    ...
    <ul id="loader" class="editor-template-list ui-portlet-list">
        ...
        ';
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=6 order by id desc limit 6");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
	...
	$res = mysql_query("select * from {$wxstyle} where type=6 order by id desc limit 6", $link);
	if ($myrow = mysql_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
...
<div id="backg-list" class="ui-portlet clearfix ">
    <ul id="loader" class="editor-template-list ui-portlet-list">
        ...
        ';
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=7 order by id desc limit 6");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
	...
	$res = mysql_query("select * from {$wxstyle} where type=7 order by id desc limit 6", $link);
	if ($myrow = mysql_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
...
<div id="pic-list" class="ui-portlet clearfix ">
    ...
    <ul id="loader" class="editor-template-list ui-portlet-list">
        ...
        ';
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=8 order by id desc limit 6");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
	...
	$res = mysql_query("select * from {$wxstyle} where type=8 order by id desc limit 6", $link);
	if ($myrow = mysql_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
...
<div id="scene-list" class="ui-portlet clearfix ">
    ...
    <ul id="loader" class="editor-template-list ui-portlet-list">
        ';
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=9 order by id desc limit 6");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
	...
	$res = mysql_query("select * from {$wxstyle} where type=9 order by id desc limit 6", $link);
	if ($myrow = mysql_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
...
<div id="style-video" class="tab-pane">
                <div id="video-list" class="ui-portlet clearfix ">
                    ...
                    <ul id="loader" class="editor-template-list ui-portlet-list">
                        ';
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=10 order by id desc limit 6");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
	...
	$res = mysql_query("select * from {$wxstyle} where type=10 order by id desc limit 6", $link);
	if ($myrow = mysql_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
...
<!-- 我的样式 -->
            ...
            <div id="style-wd" class="tab-pane">
                <div id="wd-list" class="ui-portlet clearfix ">
                    <ul id="loader" class="editor-template-list ui-portlet-list">';
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$mystyle} order by id desc");
	$myrowtest = mysqli_fetch_array($res);
	if (!$myrowtest) {
	...
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			...
			$code = $myrow[3];
			echo "<li class='col-xs-12 brush' data-id='{$sid}'>";
			echo '<div data-id="2901" class="editor.fzn.cc"><div class="fzn.cc" style="width:80%;border-style: solid; -webkit-border-image: url(http://weixinhow.com/images/mmbiz_png/p6Vlqvia1Uicw9zm8Viaw9OkgmZ7Rjyv7PxibrFr60hoYeDV2keH1svfykb7Ps8gIBkZKMibibXMmtADgoaxfN0N9GpQ/0.png) 20 70 20 70 fill; border-width:10px 35px 10px 35px; margin: 0px auto;" data-width="80%"><div style="margin:0px 10px;"><div class="fzn.cc" style="font-size: 18px; font-weight: 800; text-align: center; color: rgb(60, 40, 34);">'.$style_title.'</div></div></div></div><div class="itembox" id="eeeee" style="display: none;">';
			echo $code;
			echo "</div>";
		} while ($myrow = mysqli_fetch_array($res));
	}
} elseif ($mark == 1) {
	$res = mysql_query("select * from {$mystyle} order by id desc", $link);
	$myrowtest = mysql_fetch_array($res);
	if (!$myrowtest) {
			echo "<li class='col-xs-12 brush' data-id='111111'>";
			echo '<div data-id="2901" class="editor.fzn.cc"><div class="fzn.cc" style="width:80%;border-style: solid; -webkit-border-image: url(http://weixinhow.com/images/mmbiz_png/p6Vlqvia1Uicw9zm8Viaw9OkgmZ7Rjyv7PxibrFr60hoYeDV2keH1svfykb7Ps8gIBkZKMibibXMmtADgoaxfN0N9GpQ/0.png) 20 70 20 70 fill; border-width:10px 35px 10px 35px; margin: 0px auto;" data-width="80%"><div style="margin:0px 10px;"><div class="fzn.cc" style="font-size: 18px; font-weight: 800; text-align: center; color: rgb(60, 40, 34);">右侧“存样”可自定义样式</div></div></div></div>';
	}
            ...
            <div id="style-mb" class="tab-pane">
                <div id="mb-list" class="ui-portlet clearfix ">
                    <ul id="loader" class="editor-template-list ui-portlet-list">
                        ';
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=11 order by id desc limit 6");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
	...
	$res = mysql_query("select * from {$wxstyle} where type=11 order by id desc limit 6", $link);
	if ($myrow = mysql_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
            ...
            <div id="style-zan" class="tab-pane">
                <div id="zan-list" class="ui-portlet clearfix ">
                    ...
                    <ul id="loader" class="editor-template-list ui-portlet-list">
                        ';
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=12 order by id desc limit 6");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
	...
	$res = mysql_query("select * from {$wxstyle} where type=12 order by id desc limit 6", $link);
	if ($myrow = mysql_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
            ...
            <div id="style-sucai" class="tab-pane">
                <div id="sucai-list" class="ui-portlet clearfix ">
                    ...
                    <ul id="loader" class="editor-template-list ui-portlet-list">
                        ';
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=13 order by id desc limit 6");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
	...
	$res = mysql_query("select * from {$wxstyle} where type=13 order by id desc limit 6", $link);
	if ($myrow = mysql_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
...
<div id="fuhao-list" class="ui-portlet clearfix ">
		...
		<ul id="loader" class="editor-template-list ui-portlet-list">';
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=14 order by id desc limit 6");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
	...
	$res = mysql_query("select * from {$wxstyle} where type=14 order by id desc limit 6", $link);
	if ($myrow = mysql_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
            ...
            <div id="style-jieri" class="tab-pane">
                <div id="jieri-list" class="ui-portlet clearfix ">
                    ...
                    <ul id="loader" class="editor-template-list ui-portlet-list">
                        ';
if ($mark == 0) {
	$res = mysqli_query($link, "select * from {$wxstyle} where type=15 order by id desc limit 6");
	if ($myrow = mysqli_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
	...
	$res = mysql_query("select * from {$wxstyle} where type=15 order by id desc limit 6", $link);
	if ($myrow = mysql_fetch_array($res)) {
		do {
			$sid = $myrow[0];
			$style = $myrow[2];
