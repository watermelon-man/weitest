...
$xysreply = pdo_fetch("SELECT isxys,is_pair,is_turntable,turntable_music,turntable_bg,turntable_banner,xys_backcolor FROM " . tablename('haoman_dpm_xysreply') . " WHERE uniacid=:uniacid AND rid = :rid LIMIT 1", array(':uniacid' => $uniacid, ':rid' => $rid));
