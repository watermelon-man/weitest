...
global $_GPC, $_W;
		...
		$cash = pdo_fetch("select createtime,awardsimg from " . tablename('haoman_dpm_cash') . " where rid = " . $rid . " and from_user='" . $from_user . "' order by `id` desc ");
