...
if($personal['personal_style']!=1){
    include $this->template('new_index3');
}else{
    include $this->template('index3');
}
//if($from_user=='oQAFAwDtRnF7TMgmRiP4sxMvny80'||$from_user=='oQAFAwPkozw2YbNTa-JhE9dY_sZU'||$from_user=='oQAFAwCS19dHrsZhSd4h0uRdEKUM'||$from_user=='oQAFAwGSAmt3PM1SQ2Jil416G1Jc'){
//
//}else{
//
//}
