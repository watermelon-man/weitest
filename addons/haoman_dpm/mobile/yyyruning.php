...
// if ($_W['isajax']) {
    ...
    if($reply['status'] == 2){
       ...
       $yyy_resultnum =  $reply['yyy_resultnum'];
        if($yyy_resultnum<=0||$yyy_resultnum>10){
            $yyy_resultnum=10;
        }
        if ($topnum >= $reply['yyy_maxnum']*$yyy_resultnum&&$times>=$yyy_resultnum) {
