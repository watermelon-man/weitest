...
//        }
 ...
 $sql = 'select id,rid,pici, COUNT( DISTINCT from_user ) as `c` from ' . tablename('haoman_dpm_yyyuser') . 'where uniacid = :uniacid and rid = :rid group by pici order by `id` desc LIMIT 16';
