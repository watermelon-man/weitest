...
$nows =time();
$replys = pdo_fetch("select isbaoming,bm_endtime,registimg,bm_isqd from " . tablename('haoman_dpm_reply') . " where uniacid = :uniacid AND rid = :rid", array(':uniacid' => $uniacid,':rid' => $rid));
...
//            }
        ...
        if($nows<$replys['bm_endtime']&&$fans['isbaoming']==1&&$replys['bm_isqd']!=1){
