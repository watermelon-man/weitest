...
$.fn.wall = function () {
    ...
    return $(this).find(".send_btn").click(function () {
        ...
        return "" == $.trim(i) ? void $.tip("信息为空") : (a.find(".msg_input_box").val(""), void $.post(go_sendmsg, {content: i}, function (i) {
            console.log(i.code), 8 == i.code ? (a.find(".showing_face").removeClass("showing_face"), a.find(".showing_menu").removeClass("showing_menu"), a.find(".msg_list_ctx").css("padding-bottom", "4rem"),$(".right_index").css("bottom", "15%"), $.tip(i.data), a.loadmsg()) : $.tip("信息发送失败...")
        }, "JSON"))
    }),
