(function() {
	...
	g.prototype = {
		...
		getCpWxInfo: function() {
			return window.play_wxinfo ? (console.log(window.play_wxinfo), window.play_wxinfo) : !1
		}
	};
	window.Playgame = new g;
	window.addEventListener("message", function(a) {
		var b = {
			...
			getStorage: function(a) {
				...
				Playgame.putLocalStorage(b, a)
			},
			paysucc: function(a) {
				"function" === typeof Playgame.__paysucc && Playgame.__paysucc(a)
			},
			setCpWxInfo: function(a) {
				window.play_wxinfo = a;
				console.log(window.play_wxinfo)
			},setShareInfo:function(content){
				 window.shareInfo.share_title = content.title;
		         window.shareInfo.share_desc = content.desc; 
			} 
		};
