...
function switchsound() {
	...
	if(au.paused) {
		au.play();
		ai.src = homeurl+"images/music_note_big.png";
...
function popup_note() {
	...
	note.style.cssText = "visibility:visible;position:absolute;background-image:url('"+homeurl+"images/music_note_small.png');width:15px;height:25px";
...
function playbksound() {
	...
	if(document.body.offsetWidth > 400) {
	    bg_htm = "<img id='sound_image' src='"+homeurl+"images/music_note_big.png'>";
    	box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:-20px;top:-80px'></div>";
	} else {
	    bg_htm = "<img id='sound_image' width='30px' src='"+homeurl+"images/music_note_big.png'>";
