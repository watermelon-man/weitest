	...
	var e = function(e) {
			...
			return p = s.prototype, r(p, "bounces", function() {
				...
				var r = Math.abs(t),
					...
					a = .02,
					h = e + 500 * t;
				if (0 > h || h > i) for (h = e; 1 / 0 != Math.abs(t) && Math.abs(t) > a;) h += t, t *= 0 > h || h > i ? o * s : o, n++;
...
function(t) {
	var e = function(e) {
			function i() {
				e.call(this), this._timeScale = 1, this._paused = !1, this._callIndex = -1, this._lastTime = 0, this.callBackList = [], null != i.instance, t.sys.$ticker.$startTick(this.update, this)
			}
			__extends(i, e);
			var r = (__define, i);
